...
public class GrailsMdaMain {
	...
	public static void main(String[] args) {
		...
		extendedArgs[0] = args[0];
		// set generating path to
		extendedArgs[1] = args[1] + "/grails-app/controllers";
		// set specific modelprocessor
		processorPath = Thread.currentThread().getContextClassLoader().getResource("templates/controller/ControllerProcessor.groovy");
		extendedArgs[2] = "jar:" + processorPath.getPath();
